...
#         if key == 'Диагноз':
#             dis.append((ind, value))
#         else:
#             sym.append((ind, key, value))

# dis_kod = []
# dis_name = []
# all_dis = []
# for el in dis:
#     dis_kod.append((el[0], el[1].split(',')[1:][0].split(' ')[2:][0]))
...
# with open('db/epicrisis/outer/xTrain.csv', mode='a', encoding='utf-8', newline='') as file:
#     file_writer = csv.writer(file, delimiter=',', lineterminator='\n')
#     file_writer.writerow(fieldnames)
#     for k, v in symptoms.items():
